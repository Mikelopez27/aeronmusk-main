  ...
  <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    <div class="container mx-auto px-6 py-2">
      ...
      <div class="text-right">
        @can('Nivel create')
        <a href="{{route('admin.section.create')}}" class="bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">Crear Seccion</a>
        @endcan
      </div>
          ...
          <tbody>
            ...
            <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-4 px-6 border-b border-grey-light text-right">
                ...
                <a href="{{route('admin.section.edit',$post->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400">Editar</a>
              <td>
                <form action="{{ route('section.cambiarestado', $post->id) }}" method="POST">
                  @csrf
